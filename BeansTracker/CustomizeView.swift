...
//  Beanz
//
//  Created by Yasin on 14.02.2023.
//
...
//                Text("**Calories:** \(calories)")
                ...
                Text("Estimates shown are averages. Caffeine amounts depend on the brewing method, region and other variables.")
            }
        }
        ...
        .onAppear { // SELECT First Milk Option in Milk Based Drinks
            guard isFirstAppearance else { return }
            if drink.servedWithMilk { milk = menu.milkOptions[1] }
